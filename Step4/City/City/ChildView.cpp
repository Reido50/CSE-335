...
void CChildView::OnLButtonDown(UINT nFlags, CPoint point)
{
    ...
    if (mGrabbedItem != nullptr)
    {
        ...
        else
        {
            ...
            CMinionTransporter visitor(&mCity);
...
/** Menu handler for changing the checkmark on the Mouse History option */
...
/** Menu handler for checking the Mouse History option status 
 * \param pCmdUI Simple helper object */
...
/** Menu handler for checking the Transport option status
 *\param pCmdUI Simple helper object */
void CChildView::OnUpdateTransporterTransport(CCmdUI* pCmdUI)
{
    pCmdUI->SetCheck(mTransportMode);
}


/** Menu handler for changing the checkmark on the Transport option */
...
/** Menu handler that counts the number of buildings*/
