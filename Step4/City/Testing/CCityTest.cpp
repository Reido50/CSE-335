...
namespace Testing
{
	...
	public:
        ...
        TEST_METHOD(TestCCityVisitor)
        {
            ...
            // Make sure no visit functions are called on any empty city
            city.Accept(&visitor);
            Assert::AreEqual(0, visitor.mNumCalls,
                L"Visitor number of calls");
            ...
            // Make sure all visit functions work
            city.Accept(&visitor);
            ...
            Assert::AreEqual(4, visitor.mNumCalls,
                L"Visitor number of calls");
        }
